...
describe("Deleting first item", () => {
  ...
  const typeSecondItem = "NORMAL"
    ...
    before(() => {
        ...
        cy.request("POST","http://localhost:8080/api/items/", {"name" : nameFirstItem,"sellIn": sellinFirstItem,"quality" : qualityFirstItem,"type": typeFirstItem})
        cy.request("POST","http://localhost:8080/api/items/", {"name" : nameSecondItem,"sellIn": sellinSecondItem,"quality" : qualitySecondItem,"type": typeSecondItem})
    })
